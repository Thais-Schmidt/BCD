CREATE SCHEMA IF NOT EXISTS `db_cliente`;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_cliente`.`endereco` (
  ...
  CONSTRAINT `fk_endereco_clientes`
    ...
    REFERENCES `db_cliente`.`cliente` (`idcliente`));

-- -----------------------------------------------------
-- Table `db_clientes`.`telefone`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_cliente`.`telefone` (
...
/*Criar view*/
CREATE OR REPLACE VIEW `vw_clientes` AS SELECT * FROM CLIENTE; /*sempre começar a view com vw */

/* Selecionar uma view*/
SELECT * FROM vw_clientes;

/*Inserir dados em uma view*/
INSERT INTO vw_clientes VALUES(
null, 'ANDREIA', 'F','ANDREIA@OUTLOOK.COM','7854269');
